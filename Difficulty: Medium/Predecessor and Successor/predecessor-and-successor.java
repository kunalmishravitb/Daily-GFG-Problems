...
class Solution {
    public static void inorder(Node root, ArrayList<Node> traversed)
    {
            if (root == null) return;

            inorder(root.left, traversed);
            traversed.add(root);  // store actual Node
    ...
    public ArrayList<Node> findPreSuc(Node root, int key) {
        ...
        answer.add(pre != null ? pre : null);
        answer.add(su != null ? su : null);
